...
export const PRESET_SCENARIOS = [
  {
    id: 'scenario-1-jordan-miller',
    name: 'Jordan Miller',
    title: 'Jordan Miller — Casual Rule',
    subtitle: 'Saturday 4.98h → 4.14h Casual Hours (incl loading) + 0.84h Casual OT',
  ...
  {
    id: 'scenario-2-casey-morgan',
    name: 'Casey Morgan',
    title: 'Casey Morgan — Full-Time / Part-Time',
    subtitle: 'Saturday 4.92h → 2.11h Ordinary Hours + 2.81h Overtime 1.5x',
  ...
  {
    id: 'scenario-3-taylor-brooks',
    name: 'Taylor Brooks',
    title: 'Taylor Brooks — Sunday Split',
    subtitle: 'Sunday 1.00h → 0.69h Applicable Ordinary + 0.31h Overtime 1.5x',
    badge: 'Sunday Split',
    apply: (prev: WeekendPayInputs): WeekendPayInputs => ({
      ...prev,
      mode: 'single',
      selectedRuleId: 'sunday-overtime-split',
      payRule: 'sunday-overtime-split',
      saturdayHours: '',
      sundayHours: '1.00',
      totalTimesheetHours: '1.00',
      sundayCap: '0.69',
      saturdayConfig: undefined,
      sundayConfig: undefined,
    }),
  },
  {
    ...
    title: 'Clerks Award — Saturday OT Bands',
    subtitle: 'Saturday 4.50h → 3.00h Overtime 1.5x + 1.50h Overtime 2.0x',
    badge: 'Clerks Award',
    apply: (prev: WeekendPayInputs): WeekendPayInputs => ({
      ...prev,
      mode: 'single',
