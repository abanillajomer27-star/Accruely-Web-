...
export const LeaveAccrualCalculatorView: React.FC<LeaveAccrualCalculatorViewProps> = ({
  ...
  return (
    <div className="space-y-6 pb-12 animate-fadeIn">
      ...
      <div className="bg-orange-50/70 dark:bg-zinc-900 rounded-2xl shadow-sm border border-orange-200/80 dark:border-zinc-800 overflow-hidden transition-colors">
        ...
        <div className="p-4 sm:p-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            {/* Left Column: General Parameters & Rate Override */}
            <div className="space-y-5">
              <div className="bg-white/90 dark:bg-zinc-800/80 rounded-xl p-4 sm:p-5 border border-orange-200/80 dark:border-zinc-700 space-y-3.5">
                <div className="flex items-center gap-2 border-b border-orange-200/60 dark:border-zinc-700 pb-2.5 mb-2">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  ...
                  <button
                    ...
                    className="flex items-center justify-between gap-2 px-4 py-2 bg-orange-100/80 border border-orange-200 hover:border-orange-400 dark:bg-zinc-800 dark:border-zinc-700 dark:hover:border-zinc-600 rounded-xl text-orange-950 dark:text-zinc-100 font-semibold text-sm transition-all cursor-pointer min-w-[180px]"
                  >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  ...
                  <div className="relative min-w-[200px]">
                    <select
                      ...
                      className="w-full appearance-none px-4 py-2 bg-orange-100/80 border border-orange-200 hover:border-orange-400 dark:bg-zinc-800 dark:border-zinc-700 rounded-xl text-orange-950 dark:text-zinc-100 font-bold text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 cursor-pointer pr-10"
                    >
                      {PROFILES.map((prof) => (
                  ...
                  <div className="pt-2 space-y-3 border-t border-orange-200/60 dark:border-zinc-700 animate-fadeIn">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                      <label className="text-xs sm:text-sm font-semibold text-zinc-800 dark:text-zinc-200">
                        Custom AL Accrual Rate (hrs/paid hr)
                      </label>
                      <button
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                      <label className="text-xs sm:text-sm font-semibold text-zinc-800 dark:text-zinc-200">
                        Custom PL Accrual Rate (hrs/paid hr)
                      </label>
                      <button
            ...
            {/* Right Column: Hours Worked & Leave Taken */}
            <div className="bg-white/90 dark:bg-zinc-800/80 rounded-xl p-4 sm:p-5 border border-orange-200/80 dark:border-zinc-700 space-y-3.5">
      ...
      {/* 2 & 3. ANNUAL LEAVE & PERSONAL LEAVE COMPARISON GRID */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* 2. ANNUAL LEAVE (AL) SECTION */}
        <div className="bg-orange-50/70 dark:bg-zinc-900 rounded-2xl shadow-sm border border-orange-200/80 dark:border-zinc-800 overflow-hidden transition-colors flex flex-col justify-between">
          <div>
            {/* Banner Header */}
            <div className="bg-orange-600 dark:bg-orange-700 text-white px-5 py-3 font-bold text-base tracking-wider uppercase flex items-center justify-between">
